...
describe('navigator.hid', () => {
  ...
  afterEach(() => {
    ...
    session.defaultSession.setGrantDevicePermissionHandler(null);
  ...
  it('returns a device when DevicePermissionHandler and GrantDevicePermissionHandlers are defined', async () => {
    let haveDevices = false;
    let selectFired = false;
    ...
    session.defaultSession.setGrantDevicePermissionHandler(() => {
      grantFired = true;
    });
